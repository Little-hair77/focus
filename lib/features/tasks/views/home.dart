...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isDark ? const Color(0xFF121212) : const Color(0xFFF8F9FE);
        ...
        child: Column(
          children: [
            UserAccountsDrawerHeader(
              ...
              accountName: const Text("Pablo Henrique", style: TextStyle(fontWeight: FontWeight.bold)),
              accountEmail: const Text("Desenvolvedor"),
              currentAccountPicture: CircleAvatar(
                backgroundColor: Colors.white,
                child: Text("P", style: TextStyle(fontSize: 24, color: primaryPurple)),
              ),
            ),
            ListTile(
            ...
            const Padding(
              ...
              child: Text("Focus App v1.0", style: TextStyle(color: Colors.grey, fontSize: 12)),
            ),
          ],
        ),
      ),
